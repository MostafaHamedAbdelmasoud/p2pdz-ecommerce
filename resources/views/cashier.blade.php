...
<div class="y-col">
  ...
  <h3 id="page-title">
    <img src="https://img.icons8.com/wired/80/000000/cash-register.png" /> &nbsp; الطلبات الواردة
  </h3>
  ...
  {{-- 
  @php($myOrders = \App\Order::where('user_id', auth()->user()->id)->get()) --}}
  ...
  <div id="orders-wrapper">
    ...
    <div id="filters">
      ...
      <div>
        <a href="?state=1"><i class="fas fa-running"></i>&nbsp; طلبات جارية</a>
      </div>

      <div>
        <a href="?state=2"><i class="fas fa-flag-checkered"></i>&nbsp; طلبات منتهية</a>
      </div>

      <div>
        <a href="?state=3"><i class="far fa-window-close"></i>&nbsp; طلبات ملغية</a>
      </div>

      <div>
        <a href="/cashier"><i class="fas fa-redo-alt"></i>&nbsp; جميع الطلبات</a>
      </div>
        ...
        <a href="/orders/{{$order->id}}">
          ...
          <div class="service-info">
            ...
            <div class="order-details">
              ...
              <div><span class="material-icons">event</span> {{$order->created_at->calendar()}}</div>
            </div>
          </div>
        </a>
      </div>
