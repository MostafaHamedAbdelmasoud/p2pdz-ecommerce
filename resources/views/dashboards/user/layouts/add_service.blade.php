<h3 class="element_content_container_label"># {{ trans('dashboard.add_service') }}</h3>


<div id="add_service_tab_box" class=" element_content_container">
      ...
      <div class="row">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 com-xs-6">
          ...
          <select name="service_sub_cat" id="service_sub_cat" class="form-control" style="font-family: 'Tajawal'">
            ...
            {{-- 
            <option class="service_sub_cat_opt sub_cat_opt_money">مونى جرام</option>
            <option class="service_sub_cat_opt sub_cat_opt_money">ويسترن يونيون</option> 
            
            <option class="service_sub_cat_opt sub_cat_opt_credit">Vodafone</option>
            <option class="service_sub_cat_opt sub_cat_opt_credit">mobinil</option>
            <option class="service_sub_cat_opt sub_cat_opt_credit">Etisalat</option>
            --}}
