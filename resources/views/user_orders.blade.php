...
<div class="y-col">
  ...
  <h3 id="page-title">
    <img src="https://img.icons8.com/carbon-copy/80/000000/click-and-collect.png" /> &nbsp; المشتريات
  </h3>
  ...
  <div id="orders-wrapper">
    ...
    <div id="filters">
      ...
      <div>
        <a href="?state=1"><i class="fas fa-running"></i>&nbsp; مشتريات جارية</a>
      </div>

      <div>
        <a href="?state=2"><i class="fas fa-flag-checkered"></i>&nbsp; مشتريات منتهية</a>
      </div>

      <div>
        <a href="?state=3"><i class="far fa-window-close"></i>&nbsp; مشتريات ملغية</a>
      </div>

      <div>
        <a href="/my_orders"><i class="fas fa-redo-alt"></i>&nbsp; جميع المشتريات</a>
      </div>
